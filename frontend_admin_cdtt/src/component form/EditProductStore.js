...
export default function EditProductStore() {
    ...
    return (
        <div className="max-w-xl p-6 mx-auto mt-10 bg-gray-100 rounded-lg shadow-md">
            <h2 className="mb-6 text-2xl font-semibold text-center text-gray-700">Chỉnh Sửa Sản Phẩm Trong Kho</h2>
            <form onSubmit={handleUpdateProductStore} className="space-y-4">
                <div className="form-group">
                    ...
                    />
                    {formErrors.qty && <div className="mt-1 text-red-500">{formErrors.qty}</div>}
                </div>

                <div className="form-group">
                    <label className="block mb-1 text-gray-600">Giá Gốc:</label>
                    <input
                        type="number"
                        name="priceroot"
                        ...
                        className="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    {formErrors.priceroot && <div className="mt-1 text-red-500">{formErrors.priceroot}</div>}
                </div>
