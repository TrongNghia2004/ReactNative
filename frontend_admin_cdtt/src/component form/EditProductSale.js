...
export default function EditProductSale() {
    ...
    return (
        <div className="max-w-xl p-6 mx-auto mt-10 bg-gray-100 rounded-lg shadow-md">
            <h2 className="mb-6 text-2xl font-semibold text-center text-gray-700">Chỉnh Sửa Khuyến Mãi Sản Phẩm</h2>
            <form onSubmit={handleUpdateProductSale} className="space-y-4">
                <div className="form-group">
                    <label className="block mb-1 text-gray-600">Giá Sale:</label>
                    <input
                        type="number"
                        name="pricesale"
                    ...
                    />
                    {formErrors.pricesale && <div className="mt-1 text-red-500">{formErrors.pricesale}</div>}
                </div>

                <div className="form-group">
                    <label className="block mb-1 text-gray-600">Ngày Bắt Đầu:</label>
                    <input
                        type="date"
                        name="datebegin"
                        ...
                        className="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    {formErrors.datebegin && <div className="mt-1 text-red-500">{formErrors.datebegin}</div>}
                </div>

                <div className="form-group">
                    <label className="block mb-1 text-gray-600">Ngày Kết Thúc:</label>
                    <input
                        type="date"
                        name="dateend"
                        ...
                        className="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    {formErrors.dateend && <div className="mt-1 text-red-500">{formErrors.dateend}</div>}
                </div>
